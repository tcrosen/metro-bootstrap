...
(function baseInit(global, undefined) {
    ...
    (function (rootNamespace) {
        ...
        function defineWithParent(parentNamespace, name, members) {
            ...
            /// </param>
            /// <returns locid="WinJS.Namespace.defineWithParent_returnValue">
        ...
        function define(name, members) {
            ...
            /// The members of the new namespace.
            /// </param>
            /// <returns locid="WinJS.Namespace.define_returnValue">
            /// The newly-defined namespace.
            /// </returns>
            /// </signature>
    ...
    (function (WinJS) {
        ...
        function mix(constructor) {
            ...
            /// A constructor function that is used to instantiate this class.
            /// </param>
            /// <returns locid="WinJS.Class.mix_returnValue">
            /// The newly-defined class.
            /// </returns>
            /// </signature>
            constructor = constructor || function () { };
...
(function baseUtilsInit(global, WinJS) {
    ...
    WinJS.Namespace.define("WinJS.Utilities", {
        ...
        getMember: function (name, root) {
            ...
            /// </param>
            /// <returns locid="WinJS.Utilities.getMember_returnValue">
        ...
        ready: function (callback, async) {
            ...
            /// </summary>
            /// <returns locid="WinJS.Utilities.ready_returnValue">A promise that completes after DOMContentLoaded has occurred.</returns>
        ...
        strictProcessing: {
            get: function () { return strictProcessing; },
            configurable: false,
            enumerable: true,
        },
        ...
        markSupportedForProcessing: {
            value: function (func) {
                ...
                /// </param>
                /// <returns locid="WinJS.Utilities.markSupportedForProcessing_returnValue">
                /// The input function.
                /// </returns>
                /// </signature>
        ...
        requireSupportedForProcessing: {
            value: function (value) {
                ...
                /// or WinJS.Binding.processAll. If it is not compatible and strictProcessing is on an exception
                /// will be thrown.
                /// </summary>
                ...
                /// with a value of true when strictProcessing is on.
                /// </param>
                /// <returns locid="WinJS.Utilities.requireSupportedForProcessing_returnValue">
                /// The input value.
                /// </returns>
                /// </signature>
                if (strictProcessing) {
    ...
    WinJS.Namespace.define("WinJS", {
        ...
        strictProcessing: {
            value: function () {
                ...
                /// Turns on strict declarative processing (such as WinJS.UI.processAll or
                /// WinJS.Binding.processAll). When this is turned on all functions which
                /// are used within a declarative context must be marked with a property
                /// 'supportedForProcessing' with a value of true.
                /// </summary>
                /// </signature>
...
(function eventsInit(WinJS, undefined) {
    ...
    function createEventProperties(events) {
        ...
        /// </param>
        /// <returns locid="WinJS.Utilities.createEventProperties_returnValue">
...
(function promiseInit(global, undefined) {
    ...
    var PromiseStateMachine = WinJS.Class.define(null, {
        ...
        then: function Promise_then(onComplete, onError, onProgress) {
            ...
            /// progress.
            /// </param>
            /// <returns locid="WinJS.PromiseStateMachine.then_returnValue">
    ...
    var Promise = WinJS.Class.derive(PromiseStateMachine,
        function Promise_ctor(init, oncancel) {
            ...
            any: function Promise_any(values) {
                ...
                /// </param>
                /// <returns locid="WinJS.Promise.any_returnValue">
            ...
            as: function Promise_as(value) {
                ...
                /// </param>
                /// <returns locid="WinJS.Promise.as_returnValue">
                /// A promise.
                /// </returns>
                /// </signature>
                if (value && typeof value === "object" && typeof value.then === "function") {
            ...
            join: function Promise_join(values) {
                ...
                /// </param>
                /// <returns locid="WinJS.Promise.join_returnValue">
            ...
            then: function Promise_then(value, onComplete, onError, onProgress) {
                ...
                /// progress.
                /// </param>
                /// <returns locid="WinJS.Promise.then_returnValue">
            ...
            thenEach: function Promise_thenEach(values, onComplete, onError, onProgress) {
                ...
                /// progress.
                /// </param>
                /// <returns locid="WinJS.Promise.thenEach_returnValue">
...
(function xhrInit() {
    ...
    WinJS.Namespace.define("WinJS", {
        xhr: function (options) {
            ...
            /// </param>
            /// <returns locid="WinJS.xhr_returnValue">
...
(function elementListUtilities(global, WinJS, undefined) {
    ...
    var QueryCollection = WinJS.Class.derive(Array, function (items) {
        ...
        forEach: function (callbackFn, thisArg) {
            ...
            /// </param>
            /// <returns locid="WinJS.Utilities.QueryCollection.forEach_returnValue">
        ...
        get: function (index) {
            ...
            /// </param>
            /// <returns locid="WinJS.Utilities.QueryCollection.get_returnValue">
        ...
        setAttribute: function (name, value) {
            ...
            /// </param>
            /// <returns locid="WinJS.Utilities.QueryCollection.setAttribute_returnValue">
        ...
        addClass: function (name) {
            ...
            /// </param>
            /// <returns locid="WinJS.Utilities.QueryCollection.addClass_returnValue">
            /// This QueryCollection object.
            /// </returns>
            /// </signature>
            this.forEach(function (item) {
        ...
        removeClass: function (name) {
            ...
            /// </param>
            /// <returns locid="WinJS.Utilities.QueryCollection.removeClass_returnValue">
            /// This QueryCollection object.
            /// </returns>
            /// </signature>
            this.forEach(function (item) {
        ...
        toggleClass: function (name) {
            ...
            /// </param>
            /// <returns locid="WinJS.Utilities.QueryCollection.toggleClass_returnValue">
            /// This QueryCollection object.
            /// </returns>
            /// </signature>
            this.forEach(function (item) {
        ...
        listen: function (eventType, listener, capture) {
            ...
            /// </param>
            /// <returns locid="WinJS.Utilities.QueryCollection.listen_returnValue">
            /// This QueryCollection object.
            /// </returns>
            /// </signature>
            this.forEach(function (item) {
        ...
        removeEventListener: function (eventType, listener, capture) {
            ...
            /// </param>
            /// <returns locid="WinJS.Utilities.QueryCollection.removeEventListener_returnValue">
            /// This QueryCollection object.
            /// </returns>
            /// </signature>
            this.forEach(function (item) {
        ...
        setStyle: function (name, value) {
            ...
            /// </param>
            /// <returns locid="WinJS.Utilities.QueryCollection.setStyle_returnValue">
            /// This QueryCollection object.
            /// </returns>
            /// </signature>
            this.forEach(function (item) {
        ...
        clearStyle: function (name) {
            ...
            /// </param>
            /// <returns locid="WinJS.Utilities.QueryCollection.clearStyle_returnValue">
            /// This QueryCollection object.
            /// </returns>
            /// </signature>
            this.forEach(function (item) {
        ...
        query: function (query) {
            ...
            /// </param>
            /// <returns locid="WinJS.Utilities.QueryCollection.query_returnValue">
        ...
        control: function (ctor, options) {
            ...
            /// </param>
            /// <returns locid="WinJS.Utilities.QueryCollection.control_returnValue">
            /// This QueryCollection object.
            /// </returns>
            /// </signature>
            /// <signature>
            ...
            /// </param>
            /// <returns locid="WinJS.Utilities.QueryCollection.control_returnValue2">
            /// This QueryCollection object.
            /// </returns>
            /// </signature>
    ...
    WinJS.Namespace.define("WinJS.Utilities", {
        ...
        query: function (query, element) {
            ...
            /// </param>
            /// <returns locid="WinJS.Utilities.query_returnValue">
        ...
        id: function (id) {
            ...
            /// </param>
            /// <returns locid="WinJS.Utilities.id_returnValue">
        ...
        children: function (element) {
            ...
            /// The parent element.
            /// </param>
            /// <returns locid="WinJS.Utilities.children_returnValue">
...
(function elementUtilities(global, WinJS, undefined) {
    ...
    WinJS.Namespace.define("WinJS.Utilities", {
        ...
        data: function (element) {
            ...
            /// The element.
            /// </param>
            /// <returns locid="WinJS.Utilities.data_returnValue">
        ...
        getRelativeLeft: function (element, parent) {
            ...
            /// The parent element.
            /// </param>
            /// <returns locid="WinJS.Utilities.getRelativeLeft_returnValue">
        ...
        getRelativeTop: function (element, parent) {
            ...
            /// The parent element.
            /// </param>
            /// <returns locid="WinJS.Utilities.getRelativeTop_returnValue">
    ...
    WinJS.Namespace.define("WinJS.UI.Pages", {
        _mixin: {
            load: function (uri) {
                ...
                /// </param>
                /// <returns locid="WinJS.UI.Pages._mixin.load_returnValue">
                /// A promise whose fulfilled value is the unparented DOM elements.
                /// </returns>
                /// </signature>
                if (!this.selfhost) {
            ...
            init: function (element, options) {
                ...
                /// </param>
                /// <returns locid="WinJS.UI.Pages._mixin.init_returnValue">
                /// A promise that is fulfilled when initialization is complete.
                /// </returns>
                /// </signature>
            },
            processed: function (element, options) {
                ...
                /// </param>
                /// <returns locid="WinJS.UI.Pages._mixin.processed_returnValue">
                /// A promise that is fulfilled when initialization is complete.
                /// </returns>
                /// </signature>
            },
            render: function (element, options, loadResult) {
                ...
                /// </param>
                /// <returns locid="WinJS.UI.Pages._mixin.render_returnValue">
                /// A promise that is fulfilled when rendering is complete.
                /// </returns>
                /// </signature>
                if (!this.selfhost) {
            ...
            ready: function (element, options) {
                ...
                /// The options passed into the constructor of the page
                /// </param>
                /// <returns locid="WinJS.UI.Pages._mixin.ready_returnValue">
                /// A promise that is fulfilled when the element is ready for use.
                /// </returns>
                /// </signature>
            },
            error: function (err) {
                ...
                /// </param>
                /// <returns locid="WinJS.UI.Pages._mixin.error_returnValue">
        ...
        define: function (uri, members) {
            ...
            /// </param>
            /// <returns locid="WinJS.UI.Pages.define_returnValue">
        ...
        get: function (uri) {
            ...
            /// The URI for the content that defines the page.
            /// </param>
            /// <returns locid="WinJS.UI.Pages.get_returnValue">
            /// A constructor function that creates the page.
            /// </returns>
            /// </signature>
            uri = abs(uri);
        ...
        render: function (uri, element, options, parentedPromise) {
            ...
            /// </param>
            /// <returns locid="WinJS.UI.Pages.render_returnValue">
            /// A constructor function that creates the page.
            /// </returns>
            /// </signature>
...
(function fragmentLoaderInit(global, WinJS, undefined) {
    ...
    function renderCopy(href, target) {
        ...
        /// </param>
        /// <returns locid="WinJS.UI.Fragments.renderCopy_returnValue">
    ...
    function render(href, target) {
        ...
        /// The element to which the fragment is appended.
        /// </param>
        /// <returns locid="WinJS.UI.Fragments.render_returnValue">
        /// A promise that is fulfilled when the fragment has been loaded.
        /// If a target element is not specified, the copied fragment is the
        /// completed value.
        /// </returns>
    ...
    function cache(href) {
        ...
        /// </param>
        /// <returns locid="WinJS.UI.Fragments.cache_returnValue">
...
(function transitionAnimationInit(global, WinJS, undefined) {
    ...
    var testPrefixDivStyle = document.createElement("div").style;
    testPrefixDivStyle.msTransitionProperty = "-ms-transform";
    // Store both the name the platform outputs and the name which
    // we need to detect for substitution
    var transformNameOutput = testPrefixDivStyle.msTransitionProperty;
    var transformNameDetect = (transformNameOutput === "transform") ? "-ms-transform" : "transform";
    ...
    function copyWithEvaluation(iElem, elem) {
        return function (obj) {
            ...
            for (var p in obj) {
                ...
                // Translate the property to match what the platform emits
                if (p === "property" && v === transformNameDetect) {
                    v = transformNameOutput;
                }
                newObj[p] = v;
            }
            return newObj;
    ...
    function cancelExistingAction(id, prop) {
        var key = id + "|" + prop;
    ...
    function removeName(style, prop, name) {
        var names = style[prop].split(", ");
        var index = names.lastIndexOf(name);
        if (index >= 0) {
            names.splice(index, 1);
            style[prop] = names.join(",");
        }
    }

    function setTemporaryStyles(style, actions, desc) {
        var prevStyles = desc.props.map(function (p) {
            return style[p[0]];
        });
        ...
        var prevNames = style[desc.nameProp];
        if (prevNames !== "") {
            newShorthand = prevNames + ", " + newShorthand;
        }

        style[desc.shorthandProp] = newShorthand;

        return function(elem) {
            window.getComputedStyle(elem, null)[desc.nameProp];
            for (var i = 0; i < prevStyles.length; i++) {
                style[desc.props[i][0]] = prevStyles[i];
            }
        };
    }

    var elementTransitionProperties = {
        shorthandProp: "-ms-transition",
        nameProp: "-ms-transition-property",
        nameField: "property",
        props: [
    ...
    function executeElementTransition(elem, index, transitions, promises, animate) {
        ...
        transitions = transitions.map(copyWithEvaluation(index, elem)).filter(function (transition) {
            ...
            var schedule = (style[transition.property] !== transition.to);
            if (schedule) {
                cancelExistingAction(id, transition.property);
            }
            return schedule;
        });
        ...
        if (transitions.length > 0) {
            if (animate) {
                window.getComputedStyle(elem, null)[transitions[0].property];
                var cleanup = setTemporaryStyles(style, transitions, elementTransitionProperties);
                var listener = elem.disabled ? document : elem;

                transitions.forEach(function (transition) {
                    var finish;
                    promises.push(new WinJS.Promise(function (c, e, p) {
                        finish = function (synchronous) {
                            if (onTransitionEnd) {
                                listener.removeEventListener("MSTransitionEnd", onTransitionEnd, false);
                                removeName(style, "-ms-transition-property", transition.property);
                                unregisterAction(id, transition.property);
                                window.clearTimeout(timeoutId);
                                onTransitionEnd = null;
                            }
                            completePromise(c, synchronous);
                        };
                        ...
                        var timeoutId = window.setTimeout(function() {
                            timeoutId = window.setTimeout(finish, transition.delay + transition.duration);
                        }, 50);
                        listener.addEventListener("MSTransitionEnd", onTransitionEnd, false);
    ...
    var elementAnimationProperties = {
        shorthandProp: "-ms-animation",
        nameProp: "-ms-animation-name",
        nameField: "keyframe",
        props: [
        ...
        if (animate && anims.length > 0) {
            ...
            anims.forEach(function (anim) {
                if (!anim.keyframe) {
                    ...
                    var kf = "@-ms-keyframes " + anim.keyframe + " { from {" + anim.property + ":" + anim.from + ";} to {" + anim.property + ":" + anim.to + ";}}";
                ...
                promises.push(new WinJS.Promise(function (c, e, p) {
                    ...
                    finish = function (synchronous) {
                        if (onAnimationEnd) {
                            listener.removeEventListener("MSAnimationEnd", onAnimationEnd, false);
                            unregisterAction(id, anim.property);
                            removeName(style, "-ms-animation-name", anim.keyframe);
                            window.clearTimeout(timeoutId);
                            onAnimationEnd = null;
                        }
                        completePromise(c, synchronous);
                    ...
                    cancelExistingAction(id, anim.property);
                    registerAction(id, anim.property, finish);
                    var timeoutId = window.setTimeout(function() {
                        timeoutId = window.setTimeout(finish, anim.delay + anim.duration);
                    }, 50);
                    listener.addEventListener("MSAnimationEnd", onAnimationEnd, false);
                }, function() { finish(true); }));
            });
            setTemporaryStyles(style, anims, elementAnimationProperties)(elem);
            if (styleElem) {
    ...
    WinJS.Namespace.define("WinJS.UI", {
        ...
        executeAnimation: function (element, animation) {
            ...
            /// </param>
            /// <returns locid="WinJS.UI.executeAnimation_returnValue">
        ...
        executeTransition: function (element, transition) {
            ...
            /// </param>
            /// <returns locid="WinJS.UI.executeTransition_returnValue">
...
(function utilitiesInit(global, undefined) {
    ...
    WinJS.Namespace.define("WinJS.UI", {
        eventHandler: function (handler) {
            ...
            /// </param>
            /// <returns locid="WinJS.UI.eventHandler_returnValue">
            /// The input handler.
            /// </returns>
            /// </signature>
...
(function applicationInit(global, WinJS, undefined) {
    ...
    function dispatchEvent(eventRecord) {
        ...
        return promise.then(cleanup, function(r) {
    ...
    var builtInListeners = {
        ...
        error: [
            function Application_errorHandler(e, handled) {
                ...
                WinJS.log && WinJS.log(JSON.stringify(e), "winjs", "error");
                ...
                if (useWinRT && WinJS.Application._terminateApp) {
                    ...
                    var terminateData = { 
                        ...
                        stack: data.stack || (data.exception && data.exception.stack) || (data.error && data.error.stack) || null,
                        errorNumber: data.number || (data.exception && data.exception.number) || (data.error && data.error.number) || data.errorCode || 0 
                    };
                    WinJS.Application._terminateApp(terminateData);
                }
            }
        ],
    };
    ...
    function errorHandler(e) {
        ...
        try {
            WinJS.Application._terminateApp = function (d) {
                handled = false;
                data = d;
    ...
    function promiseErrorHandler(e) {
        ...
        //  a helper to come along after a msSetImmediate that propagates any remaining
...
(function navigationInit(WinJS, undefined) {
    ...
    var raiseBeforeNavigate = function (proposed) {
        ...
        return WinJS.Promise.as().
            then(function () {
                ...
                return promise.then(function beforeNavComplete(cancel) {
    ...
    WinJS.Namespace.define("WinJS.Navigation", {
        ...
        forward: function (distance) {
            /// <signature>
            /// <summary locid="WinJS.Navigation.forward" helpKeyword="WinJS.Navigation.forward">
            /// Navigates forwards.
            /// </summary>
        ...
        back: function (distance) {
            /// <signature>
            /// <summary locid="WinJS.Navigation.back" helpKeyword="WinJS.Navigation.back">
            /// Navigates backwards.
            /// </summary>
        ...
        navigate: function (location, initialState) {
            /// <signature>
            /// <summary locid="WinJS.Navigation.navigate" helpKeyword="WinJS.Navigation.navigate">
        ...
        addEventListener: function (eventType, listener, capture) {
            /// <signature>
            /// <summary locid="WinJS.Navigation.addEventListener" helpKeyword="WinJS.Navigation.addEventListener">
            /// Adds an event listener to the control.
            /// </summary>
        ...
        removeEventListener: function (eventType, listener, capture) {
            /// <signature>
            /// <summary locid="WinJS.Navigation.removeEventListener" helpKeyword="WinJS.Navigation.removeEventListener">
            /// Removes an event listener from the control.
            /// </summary>
    ...
    function initWithWinRT() {
        ...
        function IOHelper_ctor(folder) {
            ...
            exists: function (fileName) {
                ...
                /// </param>
                /// <returns locid="WinJS.Application.IOHelper.exists_returnValue">
            ...
            remove: function (fileName) {
                ...
                /// </param>
                /// <returns locid="WinJS.Application.IOHelper.remove_returnValue">
            ...
            writeText: function (fileName, str) {
                ...
                /// </param>
                /// <returns locid="WinJS.Application.IOHelper.writeText_returnValue">
            ...
            readText: function (fileName, def) {
                ...
                /// </param>
                /// <returns locid="WinJS.Application.IOHelper.readText_returnValue">
        ...
        var InMemoryHelper = WinJS.Class.define(
            function InMemoryHelper_ctor() {
                ...
                exists: function (fileName) {
                    ...
                    /// </param>
                    /// <returns locid="WinJS.Application.InMemoryHelper.exists_returnValue">
                    /// Promise with either true (file exists) or false.
                    /// </returns>
                    /// </signature>
                ...
                remove: function (fileName) {
                    ...
                    /// The file to be deleted
                    /// </param>
                    /// <returns locid="WinJS.Application.InMemoryHelper.remove_returnValue">
                    /// Promise which is fulfilled when the file has been deleted
                    /// </returns>
                    /// </signature>
                ...
                writeText: function (fileName, str) {
                    ...
                    /// Content to be written to the file
                    /// </param>
                    /// <returns locid="WinJS.Application.InMemoryHelper.writeText_returnValue">
                    /// Promise with the count of characters written
                    /// </returns>
                    /// </signature>
                ...
                readText: function (fileName, def) {
                    ...
                    /// Default value to be returned if the file failed to open
                    /// </param>
                    /// <returns locid="WinJS.Application.InMemoryHelper.readText_returnValue">
                    /// Promise containing the contents of the file, or def.
                    /// </returns>
                    /// </signature>
...
(function dataInit(WinJS, undefined) {
    ...
    var observableMixin = {
        ...
        bind: function (name, action) {
            ...
            /// </param>
            /// <returns locid="WinJS.Binding.observableMixin.bind_returnValue">
        ...
        unbind: function (name, action) {
            ...
            /// </param>
            /// <returns locid="WinJS.Binding.observableMixin.unbind_returnValue">
            /// This object is returned.
            /// </returns>
            /// </signature>
    ...
    var dynamicObservableMixin = {
        ...
        getProperty: function (name) {
            ...
            /// </param>
            /// <returns locid="WinJS.Binding.dynamicObservableMixin.getProperty_returnValue">
        ...
        setProperty: function (name, value) {
            ...
            /// </param>
            /// <returns locid="WinJS.Binding.dynamicObservableMixin.setProperty_returnValue">
            /// This object is returned.
            /// </returns>
            /// </signature>
        ...
        addProperty: function (name, value) {
            ...
            /// </param>
            /// <returns locid="WinJS.Binding.dynamicObservableMixin.addProperty_returnValue">
            /// This object is returned.
            /// </returns>
            /// </signature>
        ...
        updateProperty: function (name, value) {
            ...
            /// The new value of the property.
            /// </param>
            /// <returns locid="WinJS.Binding.dynamicObservableMixin.updateProperty_returnValue">
        ...
        removeProperty: function (name) {
            ...
            /// </param>
            /// <returns locid="WinJS.Binding.dynamicObservableMixin.removeProperty_returnValue">
            /// This object is returned.
            /// </returns>
            /// </signature>
    ...
    var bind = function (observable, bindingDescriptor) {
        ...
        /// </param>
        /// <returns locid="WinJS.Binding.bind_returnValue">
        ...
        Object.keys(bindingDescriptor).forEach(function (k) {
            ...
            if (listener instanceof Function) {
                ...
                var propChanged = function (v) {
                    cancelComplex(k);
                    var complexBind = bind(as(v), listener);
    ...
    var expandProperties = function (shape) {
        ...
        /// </param>
        /// <returns locid="WinJS.Binding.expandProperties_returnValue">
    ...
    var define = function (data) {
        ...
        /// </param>
        /// <returns locid="WinJS.Binding.define_returnValue">
    ...
    var as = function (data) {
        ...
        /// </param>
        /// <returns locid="WinJS.Binding.as_returnValue">
    ...
    var unwrap = function (data) {
        ...
        /// </param>
        /// <returns locid="WinJS.Binding.unwrap_returnValue">
    ...
    WinJS.Namespace.define("WinJS.Binding", {
        ...
        Template: WinJS.Class.define(
            ...
            },
            {
                ...
                /// will result in a msSetImmediate delay, any positive number will be treated as the number of milliseconds.
                /// </field>
                processTimeout: 0,
                ...
                _renderImpl: function (dataContext, container) {
                    ...
                    var renderComplete = element.
                        then(function Template_renderImpl_renderComplete_then() {
                            ...
                            // mean msSetImmediate (no setTimeout). Since Promise.timeout uses
                            // zero to mean msSetImmediate, we have to coerce.
                            //
...
(function declarativeInit(WinJS, global, undefined) {
    ...
    function buildContext(element, baseElement, skipRoot) {
        // This null is signficant, we use "undefined" to signal
        // an uninitialized context, and null to signify an
        // initialized but empty context.
        //
        if (WinJS.Utilities.strictProcessing) {
            return null;
        }
    ...
    function sourceOneBinding(bind, ref, bindingId, source, e, pend, cacheEntry) {
        ...
        if (bindable) {
            ...
            //
            makeBinding(ref, bindingId, pend, bindable, bind, cacheEntry);
        }
        else {
    ...
    function declarativeBindImpl(rootElement, dataContext, skipRoot, bindingCache, c, e, p) {
        ...
        try {
            for (var i = (neg ? -1 : 0), l = elements.length; i < l; i++) {
                ...
                if (bindingCache) {
                    if (!bindingCache.sourceCache) {
                        bindingCache.sourceCache = [];
                    }
                    source = bindingCache.sourceCache[i];
                    // have to differentiate between null (looked and not found) 
                    // and undefined (haven't looked yet)
                    if (source !== undefined) { 
                        source = bindingCache.sourceCache[i] = buildContext(element, baseElement, skipRoot);
                    }
                }
                else {
                    source = buildContext(element, baseElement, skipRoot);
                }
                ...
                // prescedence of declarative vs. specified: declarative version wins
                //
                if (source) {
                    var sourceName = source;
                    source = WinJS.Utilities._getMemberFiltered(source, global, requireSupportedForProcessing);
                    if (WinJS.log && !source) {
                        WinJS.log(WinJS.Resources._formatString(strings.dataSourceNotFound, sourceName), "winjs binding", "error");
                    }
                }
                source = (source || dataContext) || global;
                pend.count++;
                ...
                for (var bindIndex2 = 0, bindLen2 = declBind.length; bindIndex2 < bindLen2; bindIndex2++) {
                    ...
                    bind2.implementation(bind2, ref, bindingId, source, element, pend, cacheEntry);
                }
                pend.count--;
            }
        }
    ...
    function declarativeBind(rootElement, dataContext, skipRoot, bindingCache) {
        ...
        /// </param>
        /// <returns locid="WinJS.Binding.declarativeBind_returnValue">
    ...
    function converter(convert) {
        ...
        var userConverter = function (source, sourceProperties, dest, destProperties) {
            ...
            var workerResult = bindWorker(WinJS.Binding.as(source), sourceProperties, function (v) {
                var found = checkBindingToken(WinJS.Utilities._getWeakRefElement(ref), bindingId);
                if (found) {
                    nestedSet(found, destProperties, requireSupportedForProcessing(convert(requireSupportedForProcessing(v))));
                }
        ...
        return WinJS.Binding.initializer(userConverter);
    }
    ...
    function nestedSet(dest, destProperties, v) {
        ...
        for (var i = 0, len = (destProperties.length - 1) ; i < len; i++) {
            ...
            else if (WinJS.Utilities.strictProcessing && dest instanceof Node) {
    ...
    function defaultBind(source, sourceProperties, dest, destProperties) {
        ...
        /// </param>
        /// <returns locid="WinJS.Binding.defaultBind_returnValue">
        /// An object with a cancel method that is used to coalesce bindings.
        /// </returns>
        /// </signature>
        return bindWorker(WinJS.Binding.as(source), sourceProperties,
            function (v) {
    ...
    function oneTime(source, sourceProperties, dest, destProperties) {
        ...
        /// The path on the destination object to the destination property.
        /// </param>
        /// <returns locid="WinJS.Binding.oneTime_returnValue">
        /// An object with a cancel method that is used to coalesce bindings.
        /// </returns>
        /// </signature>
    ...
    function initializer(customInitializer) {
        ...
        /// </summary>
        /// <param name="customInitializer" type="Object" locid="WinJS.Binding.initializer_p:customInitializer">
        /// The custom initializer to be marked as compatible with declarative data binding.
        /// </param>
        /// <returns locid="WinJS.Binding.initializer_returnValue">
        ...
        if (period === 0) {                             // if we're using post
            if (!cleanupToken) {                        // and there isn't already one scheduled
                if (Object.keys(table).length !== 0) {  // and there are items in the table
                    msSetImmediate(cleanup);           // schedule another call to cleanup
    ...
    var FilteredListProjection = WinJS.Class.derive(ListProjection,
        function (list, filter) {
            ...
            setAt: function (index, value) {
                ...
                /// </signature>
                index = asNumber(index);
                this._list.setAt(this._list.indexOfKey(this._filteredKeys[index]), value);
            },
    ...
    var SortedListProjection = WinJS.Class.derive(ListProjection,
        function (list, sortFunction) {
            ...
            setAt: function (index, value) {
                ...
                /// </signature>
                index = asNumber(index);
                this._list.setAt(this._list.indexOfKey(this._sortedKeys[index]), value);
            },
        ...
        function (list, groupKeyOf, groupDataOf, groupSorter) {
            ...
            _listGroupedItemMutated: function (event) {
                ...
                if (oldGroupedItem.groupKey === groupKey) {
                    ...
                    groupedItems[key] = newGroupedItem;
                    this._listItemMutated({ detail: { key: key, value: value, item: oldGroupedItem } });
                }
            },
